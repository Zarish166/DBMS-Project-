...
SECRET_KEY = 'django-insecure-d8r%0*+bg$skkyt^le8*e+*nar2=@17vh0%5s%oe++gzhpmb(o'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates')],  # Optionally add paths to directories of your templates
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
AUTHENTICATION_BACKENDS = [
    'web.backends.EmployeeAuthenticationBackend',
]
